package com.ComponentTestScripts.excelReader;
...
public class Excel_Reader {
	...
	public static void main(String[] args) { 
		String excellocation = "E:/FrameworkComponents-TestScripts/ComponentTestScripts/src/main/java/com/ComponentTestScripts/data/TestData.xlsx";
